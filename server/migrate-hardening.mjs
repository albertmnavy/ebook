...
const version = '20260911_finance_hardening';
const sql = await readFile(new URL('./migrations/20260911_finance_hardening.sql', import.meta.url), 'utf8');
...
try {
  ...
  if (existing.rows[0]) {
    ...
    console.log('Finance hardening migration is already up to date.');
  } else {
