...
function packageView(plan) {
  ...
  return { ...plan, daily_roi_minor: dailyRoiMinor, total_return_minor: basicTotalReturnMinor(plan.amount_minor, plan.duration_days) };
}
