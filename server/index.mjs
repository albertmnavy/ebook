...
function packageView(plan) {
  ...
  const dailyRoiMinor = basicRoiMinor(plan.amount_minor);
  return { ...plan, daily_roi_minor: dailyRoiMinor, total_return_minor: dailyRoiMinor * Number(plan.duration_days) };
}
